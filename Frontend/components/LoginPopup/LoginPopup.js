    ...
    <div className='login-popup'>
        <form onSubmit={onLogin} className='login-popup-container'>
            ...
            <div className='login-popup-condition'>
                ...
                <p>By using this service, I agree to the Terms of Service and Privacy Policy.</p>
            </div>
            {currState === 'Login'
                ? <p>Create a new Account?? <span onClick={() => setCurrState('Sign Up')}>Click On Me</span></p>
